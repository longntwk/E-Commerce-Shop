...
public class MessageKeys {
    ...
    public static final String WRONG_PHONE_PASSWORD ="user.login.login_failed_phone_password";
    ...
    public static final String UPLOAD_IMAGES_FILE_MUST_BE_IMAGE = "product.upload_images.file_large";
    public static final String INSERT_CATEGORY_FAILED = "product.upload_images.file_must_be-image";
